...
//		
//		OtherStudent otherStudent = ctx.getBean("otherStudent", OtherStudent.class); //사용 Use
//		System.out.println("Name: " + otherStudent.getName()); //사용
//		System.out.println("Age: " + otherStudent.getAge()); //사용
